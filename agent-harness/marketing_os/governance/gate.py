...
def check_gate(settings: Settings, customer: str, slug: str) -> GateReport:
    ...
    if not dna_path.is_file():
        report.dna_issues.append(
            ...
            f"cp templates/customer-dna.md customers/{customer}/dna.md, then fill every Required field."
        )
    else:
    ...
    if not goal_path.is_file():
        report.goal_issues.append(
            ...
            f"cp templates/campaign-goal.md campaigns/{slug}/goal.md, then fill every Required field."
        )
    else:
